...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (selectedChat) {
      ...
      // Mark unread messages as read immediately when chat is opened
  ...
  // Handle "Hubungi Mitra" from Product Detail
  useEffect(() => {
  ...
  async function handleMitraChatFromUrl(mitraId: string) {
    // Fetch mitra details to start chat
  ...
  async function fetchConversations() {
    ...
    // Get all conversations untuk user ini
  ...
  async function startChat(partnerId: string, partnerRole: string, orderId?: string) {
    ...
    // If partnerId is "admin-id", fetch actual admin from database
