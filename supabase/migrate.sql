-- ============================================
-- MIGRASI: Update Schema ke Revised Version
-- ============================================
-- Jalankan ini untuk update database yang sudah ada
-- File ini akan DROP tables lama dan CREATE yang baru

-- ⚠️ PERHATIAN: Ini akan menghapus semua data yang sudah ada!
-- Kalau ada data penting, backup dulu!

-- ============================================
-- 1. DROP TABLES EXISTING (kalau ada)
-- ============================================
...
-- Reviews (bisa dibuat setelah pesanan selesai)
...
-- Trigger update rating produk otomatis saat ada review baru
...
-- ============================================
-- ✅ SELESAI! Database sudah diupdate ke schema baru
-- ============================================
